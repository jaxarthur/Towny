...
public enum ConfigNodes {
	...
	GTOWN_FARM_PLOT_ALLOW_BLOCKS(
			...
			"# Not included by default but some servers add GRASS,SOIL,DIRT to their list."
	),
	GTOWN_FARM_ANIMALS(
...
//			"# Cost to use /plot set outpost to change a normal plot to a outpost plot."),
	...
	WAR_WARZONE_EDITABLE_MATERIALS(
			...
			"tnt,fence,ladder,wooden_door,iron_door,fire",
	...
	WAR_WARZONE_EXPLOSIONS_IGNORE_LIST(
			...
			"WOODEN_DOOR,IRON_DOOR,CHEST,TRAPPED_CHEST,FURNACE,BURNING_FURNACE,DROPPER,DISPENSER,HOPPER,ENDER_CHEST,WHITE_SHULKER_BOX,ORANGE_SHULKER_BOX,MAGENTA_SHULKER_BOX,LIGHT_BLUE_SHULKER_BOX,YELLOW_SHULKER_BOX,LIME_SHULKER_BOX,PINK_SHULKER_BOX,GRAY_SHULKER_BOX,SILVER_SHULKER_BOX,CYAN_SHULKER_BOX,PURPLE_SHULKER_BOX,BLUE_SHULKER_BOX,BROWN_SHULKER_BOX,GREEN_SHULKER_BOX,RED_SHULKER_BOX,BLACK_SHULKER_BOX,NOTE_BLOCK,LEVER,STONE_PLATE,IRON_DOOR_BLOCK,WOOD_PLATE,JUKEBOX,DIODE_BLOCK_OFF,DIODE_BLOCK_ON,FENCE_GATE,GOLD_PLATE,IRON_PLATE,REDSTONE_COMPARATOR_OFF,REDSTONE_COMPARATOR_ON,BEACON",
